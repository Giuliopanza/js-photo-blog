...
.then(data => {
    ...
    data.forEach(element => {    
         row.innerHTML += `
         <div class="col-lg-3 col-md-5 col-sm-12 m-2 p-2 bg-white position-relative">
    ...
    arraycol.forEach(element =>{
        element.addEventListener('click',function (){
            ...
            container.innerHTML =`
                <div class="position-fixed bg-secondary top-0 start-0 bottom-0 end-0 d-flex justify-content-center align-items-center flex-column">
                    <img src="" alt="immagine" id="imgover">
